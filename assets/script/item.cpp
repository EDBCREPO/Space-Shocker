...
namespace rl { namespace game {
    ...
    /*.........................................................................*/
        ...
        coStart; coDelay( 1000 ); do { item_t item;
            ...
            item_t part; part.state = 0; part.speed = 30.0f;
                   part.pos = item.pos;  part.size  = 30.0f;
                   part.col = item.state ? GREEN : WHITE;

            obj->particle.push( part ); obj->list.push( item );
    ...
    /*.........................................................................*/
        ...
        coStart; coDelay(100); do { static bool b = 0;
            auto x = obj->list.last(); while( x!=nullptr ){
                item_t item; item.state = b; item.speed = 30.0f;
                item.pos = x->data.pos; item.size = 20.0f;
                item.col = x->data.state ? GREEN : WHITE;
